...
class TCP_Puppy extends TCP_CustomPostType {
	private static $instance;
	
	protected function __construct() {
		parent::__construct('Puppy', array(
				'menu_icon' => 'dashicons-location-alt',
				'rewrite'	=> array( 'slug' => 'puppies' ),
				'show_in_nav_menus'	=> true,
				'show_in_menu'	=> true,
				'supports' => get_option('tcp_puppy_editor' ) ? array( 'title' ) : array('title', 'editor')
		));
		$this->add_meta_box('Puppy Fields', array(
			'Puppy Custom Name'	=> array(
	...
	public function register_widgets() {
		register_widget( 'tcp_Puppy_Widget' );
	}
}

class tcp_Puppy_Widget extends WP_Widget {
